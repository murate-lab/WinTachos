...
// ■↓デバッグ
		char dbg[1024];
		sprintf_s(dbg, sizeof(dbg), "CPU:%f\\n", m_fTacho);
...
/*		pNeedle[2].x = m_NeedleInfo[i].poCenter.x + (long)(4.0f * cos(fAngleR_rad));
		...
		pNeedle[4].x = pNeedle[0].x + (long)(3.0f * cos(fAngleL_rad));
		pNeedle[4].y = pNeedle[0].y - (long)(3.0f * sin(fAngleL_rad));
		pNeedle[5].x = pNeedle[0].x + (long)(3.0f * cos(fAngleR_rad));
		pNeedle[5].y = pNeedle[0].y - (long)(3.0f * sin(fAngleR_rad));
...
/*		pNeedle[0].x = m_NeedleInfo[i].poCenter.x + (long)(-m_NeedleInfo[i].uiLengB * cos(fAngleC_rad));
		...
		pNeedle[2].y = m_NeedleInfo[i].poCenter.y - (long)(4.0f * sin(fAngleL_rad));
		pNeedle[3].x = m_NeedleInfo[i].poCenter.x + (long)(4.0f * cos(fAngleR_rad));
		pNeedle[3].y = m_NeedleInfo[i].poCenter.y - (long)(4.0f * sin(fAngleR_rad));
		pNeedle[4].x = pNeedle[0].x + (long)(4.0f * cos(fAngleR_rad));
		pNeedle[4].y = pNeedle[0].y - (long)(4.0f * sin(fAngleR_rad));
		pNeedle[5].x = pNeedle[0].x + (long)(4.0f * cos(fAngleL_rad));
		pNeedle[5].y = pNeedle[0].y - (long)(4.0f * sin(fAngleL_rad));
